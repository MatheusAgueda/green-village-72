...
export const PRESENTATION_REVISION='GV72-R7-2026-09-10';
...
export async function createPortfolioPDF(s,{image,planImage}={}){
 ...
 text(cover,`${layout.bedrooms} quartos · 1 casa de banho · ${s.roof?'telhado triangular':'cobertura plana'}${s.porch?' · alpendre seleccionado':''}`,M,214,{size:11,width:W-2*M});
 ...
 text(plan,layout.label+' · '+layout.bedrooms+' quartos · 1 casa de banho',M,673,{size:12,font:bold});
 ...
 text(detail,'Sem preço total determinado. Valores opcionais do catálogo com IVA 23%, sujeitos a compatibilidade. Este resumo não substitui a proposta comercial nem um projecto de execução. Redes, pormenores não cotados e expansão são ilustrativos.',M,y-20,{size:9,width:W-2*M,color:muted});
